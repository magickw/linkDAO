...
import { dexService } from '@linkdao/shared/services/dexService';
import type { SwapQuoteResult, TokenInfo } from '@linkdao/shared/services/dexService';
...
export default function SwapScreen() {
    ...
    useEffect(() => {
        const loadTokens = async () => {
            ...
            if (tokens.length > 0) setTokenIn(tokens[0]!);
            if (tokens.length > 1) setTokenOut(tokens[1]!);
        };
        loadTokens();
    }, []);
