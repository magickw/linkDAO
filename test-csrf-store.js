// Test to verify CSRF store behavior
...
// Test the store behavior
console.log('=== CSRF Store Test ===');
...
console.log(`Store size: ${csrfStore.size}`);
console.log(`Store keys: ${Array.from(csrfStore.keys()).join(', ')}`);
...
// 5. Test with different case
console.log('\n5. Testing with different case...');
