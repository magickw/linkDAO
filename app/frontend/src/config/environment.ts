...
export const ENV_CONFIG = {
  ...
  CONTRACT_REGISTRY_ADDRESS: process.env.NEXT_PUBLIC_CONTRACT_REGISTRY_ADDRESS || '0x0000000000000000000000000000000000000000', // Will be updated after deployment
