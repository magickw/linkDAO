        ...
        <div className="p-6 space-y-4">
          ...
          <div className="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-gray-900 dark:text-white">~$3.20</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-gray-600 dark:text-gray-400">Swap Fee (0.3%):</span>
              <span className="text-gray-900 dark:text-white">
                ~${fromAmount ? (parseFloat(fromAmount) * (fromTokenData?.valueUSD || 0) / (fromTokenData?.balance || 1) * 0.003).toFixed(2) : '0.00'}
              </span>
            </div>
          </div>
        </div>
