  ...
  return (
    <>
      ...
      <button
        ...
        data-cursor="tip"
        className={`flex items-center justify-center space-x-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors duration-200 ${className}`}
      >
