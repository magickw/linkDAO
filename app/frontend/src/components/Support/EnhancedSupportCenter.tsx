...
interface EnhancedSupportCenterProps {
  userEmail?: string;
  isAdmin?: boolean;
}

const EnhancedSupportCenter: React.FC<EnhancedSupportCenterProps> = ({
  userEmail,
  isAdmin = false
}) => {
  ...
  const supportMetrics = [
    ...
    { title: 'Satisfaction Score', value: '4.8/5', change: '+0.1', icon: Star },
  ];
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Get help with LDAO tokens, marketplace, wallet, and technical issues
            </p>
          </div>
          <div className="flex items-center space-x-4">
            ...
            {/* Remove the language and cultural adaptation components for now */}
          </div>
        </div>
      </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Get instant help from our support team. Available 24/7 with average response time of 2 minutes.
              </p>
              <button 
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                For detailed inquiries and complex issues. Average response time is 4 hours.
              </p>
              <a 
                href="mailto:support@linkdao.io" 
                className="w-full bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 transition-colors text-center block"
              >
                Send Email
              </a>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Join our Discord community for peer-to-peer support and discussions.
              </p>
              <a 
                href="https://discord.gg/linkdao" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition-colors text-center block"
              >
                Join Discord
              </a>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/support/tickets" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium">
                View all
              </a>
            </div>
            <SupportTicketDashboard userEmail={userEmail} isAdmin={isAdmin} />
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/support/documents" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm font-medium">
                Browse all
              </a>
            </div>
            <SupportDocuments />
