      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
          <div className="flex items-center space-x-1">
            ...
            <span>{(post.engagementMetrics?.likes || 0).toLocaleString()}</span>
          </div>
          ...
          <div className="flex items-center space-x-1">
            ...
            <span>{(post.engagementMetrics?.comments || 0).toLocaleString()}</span>
          </div>
          ...
          <div className="flex items-center space-x-1">
            ...
            <span>{(post.engagementMetrics?.reposts || 0).toLocaleString()}</span>
          </div>

          {(post.engagementMetrics?.tips || 0) > 0 && (
            <div className="flex items-center space-x-1 text-yellow-600 dark:text-yellow-400">
              ...
              <span>{(post.engagementMetrics?.tips || 0).toLocaleString()}</span>
            </div>
          )}
        </div>

        {/* Engagement Rate */}
        <div className={`text-sm font-medium ${getEngagementColor(post.engagementMetrics?.engagementRate || 0)}`}>
          {((post.engagementMetrics?.engagementRate || 0) * 100).toFixed(1)}% engagement
        </div>
      </div>

      {/* Social Proof */}
      {post.socialProof?.followedUsersWhoEngaged && post.socialProof.followedUsersWhoEngaged.length > 0 && (
