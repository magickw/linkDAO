        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center space-x-1 bg-gray-50 dark:bg-gray-800/50 rounded-lg p-1">
            <button
              ...
              disabled={!onUpvote}
              className={`flex items-center space-x-1 p-2 rounded-md transition-colors min-h-[44px] min-w-[40px] ${userVote === 'upvote'
            ...
            <button
              ...
              disabled={!onDownvote}
              className={`flex items-center space-x-1 p-2 rounded-md transition-colors min-h-[44px] min-w-[40px] ${userVote === 'downvote'
          ...
          <button
            ...
            className="flex items-center space-x-2 p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 text-sm font-medium transition-colors duration-200 hover:scale-105 min-h-[44px]"
          >
          ...
          {postType !== 'community' && !post.communityId && (
            <div className="relative group" ref={repostMenuRef}>
              <button
                ...
                className={`flex items-center space-x-2 p-2 text-sm font-medium transition-colors duration-200 hover:scale-105 min-h-[44px] ${post.isRepostedByMe
          ...
          {!zenMode && (
            <div className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 text-sm font-medium p-2 min-h-[44px]" title={`${post.views || 0} Views`}>
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className={`flex items-center space-x-2 p-2 text-sm font-medium transition-colors duration-200 hover:scale-105 min-h-[44px] ${isBookmarked
