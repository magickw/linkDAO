        ...
        setListings([
          {
            ...
            sellerWalletAddress: '0xc4f4cb013c4121d2dbd5b063eefe074f0ebc03f3',
            tokenAddress: '0xc4f4cb013c4121d2dbd5b063eefe074f0ebc03f3',
            price: '0.99',
            quantity: 15,
            itemType: 'DIGITAL',
          ...
          },
          {
            ...
            sellerWalletAddress: '0x72f58fe0e30a3f2fa96720d7ad85b4a8ef767d05',
            tokenAddress: '0x72f58fe0e30a3f2fa96720d7ad85b4a8ef767d05',
            price: '2.99',
            quantity: 1,
            itemType: 'NFT',
            listingType: 'AUCTION',
          ...
          },
          {
            ...
            status: 'ACTIVE',
            startTime: new Date().toISOString(),
            metadataURI: 'Blockchain Development Course',
            isEscrowed: true,
            createdAt: new Date().toISOString(),
            updatedAt: new Date().toISOString()
          },
          {
            ...
            status: 'ACTIVE',
            startTime: new Date().toISOString(),
            metadataURI: 'Web3 Design Template Pack',
            isEscrowed: true,
            createdAt: new Date().toISOString(),
            updatedAt: new Date().toISOString()
          }
