          ...
          <div className="flex flex-wrap items-center justify-between mb-6 p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow border border-white/30 dark:border-gray-700/50">
            ...
            <div className="flex flex-wrap gap-2">
              <select
                ...
                className="bg-gray-100/80 dark:bg-gray-700/50 border-0 rounded-full text-sm font-medium text-gray-700 dark:text-gray-300 focus:ring-primary-500"
              >
          ...
          {mockPosts.length === 0 && (
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow border border-white/30 dark:border-gray-700/50 p-12 text-center">
              ...
              {isConnected ? (
                ...
                <div className="mt-6">
                  <button className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-primary-600 to-secondary-600 hover:from-primary-700 hover:to-secondary-700">
                    Connect Wallet
                  </button>
                </div>
              )}
            ...
            <form className="p-6">
              ...
              <div className="flex justify-end space-x-3">
                <button
                  type="button"
                  onClick={() => setIsCreateModalOpen(false)}
                  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-offset-gray-800"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-gradient-to-r from-primary-600 to-secondary-600 hover:from-primary-700 hover:to-secondary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                >
                  Post
                </button>
              </div>
