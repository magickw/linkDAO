        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <button
              ...
              className={`flex items-center gap-2 py-3 px-4 rounded-lg transition-colors ${activeTab === 'overview'
            ...
            <button
              ...
              className={`flex items-center gap-2 py-3 px-4 rounded-lg transition-colors ${activeTab === 'staking'
                  ? 'bg-purple-500/20 text-white border border-purple-500'
                  : 'bg-white/10 text-white/70 hover:bg-white/20'
                }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 py-3 px-4 rounded-lg transition-colors ${activeTab === 'referral'
                  ? 'bg-purple-500/20 text-white border border-purple-500'
                  : 'bg-white/10 text-white/70 hover:bg-white/20'
                }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 py-3 px-4 rounded-lg transition-colors ${activeTab === 'history'
                  ? 'bg-purple-500/20 text-white border border-purple-500'
                  : 'bg-white/10 text-white/70 hover:bg-white/20'
                }`}
            >
