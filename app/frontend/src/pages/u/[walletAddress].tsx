...
export default function PublicProfile() {
  ...
  const [activeTab, setActiveTab] = useState<'posts' | 'followers' | 'following' | 'social' | 'comments' | 'upvotes' | 'downvotes' | 'documents'>('posts');
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-4 lg:mt-0">
                  ...
                  {currentUserAddress && currentUserAddress !== profile.walletAddress && (
                    <>
                      ...
                      {/* Message Button */}
                      <button
                        onClick={() => router.push(`/chat?recipient=${encodeURIComponent(profile.walletAddress)}`)}
