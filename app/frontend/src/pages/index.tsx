      ...
      <>
        ...
        <Layout title="LinkDAO - The Web3 Social Network" fullWidth={true}>
          ...
          <div className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-gray-900">
            ...
            <div className="relative z-10 max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12 pt-20 pb-16 text-center lg:text-left lg:flex lg:items-center lg:justify-between lg:gap-20">
