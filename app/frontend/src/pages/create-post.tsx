            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              ...
              {loadingCommunities ? (
                ...
                <div className="text-center py-8 px-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-2">You haven't joined any communities yet</p>
                  <p className="text-sm text-gray-500 dark:text-gray-500 mb-4">
                    Join communities to post in them, or create a global post instead
                  </p>
                  <button
                    type="button"
