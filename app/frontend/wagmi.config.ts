...
// Group contracts by functionality to reduce the number of files
...
export default defineConfig([
  {
    out: 'src/generated/social.ts',
    contracts: socialContracts,
    plugins: [react()],
  },
  {
    out: 'src/generated/payments.ts',
    contracts: paymentContracts,
    plugins: [react()],
  },
  {
    out: 'src/generated/governance.ts',
    contracts: governanceContracts,
    plugins: [react()],
  },
  {
    out: 'src/generated/charity.ts',
    contracts: charityContracts,
    plugins: [react()],
  },
  {
    out: 'src/generated/tokens.ts',
    contracts: tokenContracts,
    plugins: [react()],
  },
  {
    out: 'src/generated/marketplace.ts',
