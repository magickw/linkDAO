...
export interface FixedLDAOTreasuryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MULTI_SIG_THRESHOLD"
      | "addPricingTier"
  ...
  encodeFunctionData(
    functionFragment: "updateETHPriceFeed",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace ETHPriceFeedUpdatedEvent {
...
export interface FixedLDAOTreasury extends BaseContract {
  connect(runner?: ContractRunner | null): FixedLDAOTreasury;
  waitForDeployment(): Promise<this>;

  interface: FixedLDAOTreasuryInterface;
  ...
  updateETHPriceFeed: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "updateETHPriceFeed"
  ...
  >;
  getEvent(
    key: "ETHPriceFeedUpdated"
  ): TypedContractEvent<
    ETHPriceFeedUpdatedEvent.InputTuple,
    ETHPriceFeedUpdatedEvent.OutputTuple,
    ETHPriceFeedUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "EmergencyStop"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ETHPriceFeedUpdated(address)": TypedContractEvent<
      ETHPriceFeedUpdatedEvent.InputTuple,
      ETHPriceFeedUpdatedEvent.OutputTuple,
      ETHPriceFeedUpdatedEvent.OutputObject
    >;
    ETHPriceFeedUpdated: TypedContractEvent<
      ETHPriceFeedUpdatedEvent.InputTuple,
      ETHPriceFeedUpdatedEvent.OutputTuple,
      ETHPriceFeedUpdatedEvent.OutputObject
    >;
