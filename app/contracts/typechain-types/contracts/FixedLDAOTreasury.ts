...
export interface FixedLDAOTreasuryInterface extends utils.Interface {
  functions: {
    ...
    "updateETHPriceFeed(address)": FunctionFragment;
  ...
  events: {
    ...
    "ETHPriceFeedUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ETHPriceFeedUpdated"): EventFragment;
...
export interface ETHPriceFeedUpdatedEventObject {
  newPriceFeed: string;
}
export type ETHPriceFeedUpdatedEvent = TypedEvent<
  [string],
  ETHPriceFeedUpdatedEventObject
>;

export type ETHPriceFeedUpdatedEventFilter =
  TypedEventFilter<ETHPriceFeedUpdatedEvent>;
...
export interface FixedLDAOTreasury extends BaseContract {
  ...
  functions: {
    ...
    ethPriceFeed(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "ETHPriceFeedUpdated(address)"(
      newPriceFeed?: PromiseOrValue<string> | null
    ): ETHPriceFeedUpdatedEventFilter;
    ETHPriceFeedUpdated(
      newPriceFeed?: PromiseOrValue<string> | null
    ): ETHPriceFeedUpdatedEventFilter;
  ...
  estimateGas: {
    ...
    ethPriceFeed(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ethPriceFeed(overrides?: CallOverrides): Promise<PopulatedTransaction>;
