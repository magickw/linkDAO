...
export declare namespace SimpleProfileRegistry {
  ...
  export type ProfileStructOutput = [string, string, BigNumber] & {
    handle: string;
    avatarCid: string;
    createdAt: BigNumber;
  };
...
export interface SimpleProfileRegistryInterface extends utils.Interface {
  functions: {
...
export interface SimpleProfileRegistry extends BaseContract {
  ...
  functions: {
    ...
    getProfileByAddress(
      ...
      overrides?: CallOverrides
    ): Promise<[SimpleProfileRegistry.ProfileStructOutput]>;
