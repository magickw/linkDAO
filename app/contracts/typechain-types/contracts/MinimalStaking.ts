...
export interface MinimalStakingInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ldaoToken"
      | "owner"
...
export interface MinimalStaking extends BaseContract {
  connect(runner?: ContractRunner | null): MinimalStaking;
  waitForDeployment(): Promise<this>;

  interface: MinimalStakingInterface;
