...
export interface LDAOBridgeTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MAX_SUPPLY"
...
export namespace BridgeBurnEvent {
  ...
  export type OutputTuple = [from: string, amount: bigint, txHash: string];
  export interface OutputObject {
    from: string;
    amount: bigint;
    txHash: string;
...
export namespace BridgeMintEvent {
  ...
  export type OutputTuple = [to: string, amount: bigint, txHash: string];
  export interface OutputObject {
    to: string;
    amount: bigint;
    txHash: string;
...
export interface LDAOBridgeToken extends BaseContract {
  connect(runner?: ContractRunner | null): LDAOBridgeToken;
  ...
  bridgeBurn: TypedContractMethod<
    [from: AddressLike, amount: BigNumberish, txHash: BytesLike],
    [void],
    "nonpayable"
  >;

  bridgeMint: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, txHash: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "BridgeBurn(address,uint256,bytes32)": TypedContractEvent<
      BridgeBurnEvent.InputTuple,
      BridgeBurnEvent.OutputTuple,
      BridgeBurnEvent.OutputObject
    >;
    ...
    "BridgeMint(address,uint256,bytes32)": TypedContractEvent<
      BridgeMintEvent.InputTuple,
      BridgeMintEvent.OutputTuple,
      BridgeMintEvent.OutputObject
    >;
