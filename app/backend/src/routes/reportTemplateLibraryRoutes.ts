...
import { reportTemplateLibraryController } from '../controllers/reportTemplateLibraryController.js';
...
// Category Management
router.post('/categories', reportTemplateLibraryController.createCategory.bind(reportTemplateLibraryController));
...
router.put('/categories/:id', reportTemplateLibraryController.updateCategory.bind(reportTemplateLibraryController));
router.delete('/categories/:id', reportTemplateLibraryController.deleteCategory.bind(reportTemplateLibraryController));

// Template Categorization
router.post('/templates/:templateId/categories/:categoryId', reportTemplateLibraryController.addTemplateToCategory.bind(reportTemplateLibraryController));
router.delete('/templates/:templateId/categories/:categoryId', reportTemplateLibraryController.removeTemplateFromCategory.bind(reportTemplateLibraryController));
...
// Usage Analytics
router.post('/templates/:templateId/usage', reportTemplateLibraryController.recordTemplateUsage.bind(reportTemplateLibraryController));
...
// Rating System
router.post('/templates/:templateId/ratings', reportTemplateLibraryController.rateTemplate.bind(reportTemplateLibraryController));
...
router.post('/templates/:templateId/shares', reportTemplateLibraryController.shareTemplate.bind(reportTemplateLibraryController));
...
router.delete('/shares/:shareId', reportTemplateLibraryController.revokeShare.bind(reportTemplateLibraryController));

// Version Control
router.post('/templates/:templateId/versions', reportTemplateLibraryController.createTemplateVersion.bind(reportTemplateLibraryController));
...
// Approval Workflow
router.post('/templates/:templateId/approval', reportTemplateLibraryController.submitTemplateForApproval.bind(reportTemplateLibraryController));
router.post('/approvals/:approvalId/approve', reportTemplateLibraryController.approveTemplate.bind(reportTemplateLibraryController));
router.post('/approvals/:approvalId/reject', reportTemplateLibraryController.rejectTemplate.bind(reportTemplateLibraryController));
