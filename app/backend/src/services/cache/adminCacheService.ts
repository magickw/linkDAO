...
export class AdminCacheService {
  ...
  constructor() {
    ...
    this.redis.on('connect', () => {
      safeLogger.info('Admin cache service connected to Redis');
    });

    this.redis.on('error', (error) => {
      safeLogger.error('Redis cache error:', error);
    });
  }
  ...
  async getDashboardMetrics(): Promise<DashboardMetrics | null> {
    try {
      ...
      safeLogger.error('Error getting cached dashboard metrics:', error);
      return null;
    }
  }
  ...
  async cacheDashboardMetrics(metrics: DashboardMetrics, ttl: number = 30): Promise<void> {
    try {
      ...
      safeLogger.error('Error caching dashboard metrics:', error);
    }
  }
  ...
  async getUser(userId: string): Promise<UserCacheData | null> {
    try {
      ...
      safeLogger.error('Error getting cached user:', error);
      return null;
    }
  }
  ...
  async cacheUser(user: UserCacheData, ttl: number = 600): Promise<void> {
    try {
      ...
      safeLogger.error('Error caching user:', error);
    }
  }
  ...
  async getUserList(page: number, filters?: Record<string, any>): Promise<any | null> {
    try {
      ...
      safeLogger.error('Error getting cached user list:', error);
      return null;
    }
  }
  ...
  async cacheUserList(
    ...
    try {
      ...
      safeLogger.error('Error caching user list:', error);
    }
  }
  ...
  async invalidateUser(userId: string): Promise<void> {
    try {
      ...
      safeLogger.error('Error invalidating user cache:', error);
    }
  }
  ...
  async getModerationQueue(filters?: Record<string, any>): Promise<any | null> {
    try {
      ...
      safeLogger.error('Error getting cached moderation queue:', error);
      return null;
    }
  }
  ...
  async cacheModerationQueue(
    ...
    try {
      ...
      safeLogger.error('Error caching moderation queue:', error);
    }
  }
  ...
  async invalidateModerationQueue(): Promise<void> {
    try {
      ...
      safeLogger.error('Error invalidating moderation queue cache:', error);
    }
  }
  ...
  async getAnalytics(metric: string, timeRange: string): Promise<any | null> {
    try {
      ...
      safeLogger.error('Error getting cached analytics:', error);
      return null;
    }
  }
  ...
  async cacheAnalytics(
    ...
    try {
      ...
      safeLogger.error('Error caching analytics:', error);
    }
  }
  ...
  async getAIModerationResult(contentId: string): Promise<any | null> {
    try {
      ...
      safeLogger.error('Error getting cached AI result:', error);
      return null;
    }
  }
  ...
  async cacheAIModerationResult(
    ...
    try {
      ...
      safeLogger.error('Error caching AI result:', error);
    }
  }
  ...
  async get<T>(key: string, options?: CacheOptions): Promise<T | null> {
    try {
      ...
      safeLogger.error(`Error getting cached key ${key}:`, error);
      return null;
    }
  }
  ...
  async set<T>(key: string, value: T, options?: CacheOptions): Promise<void> {
    try {
      ...
      safeLogger.error(`Error setting cached key ${key}:`, error);
    }
  }
  ...
  async delete(key: string, options?: CacheOptions): Promise<void> {
    try {
      ...
      safeLogger.error(`Error deleting cached key ${key}:`, error);
    }
  }
  ...
  async deletePattern(pattern: string, options?: CacheOptions): Promise<void> {
    try {
      ...
      safeLogger.error(`Error deleting pattern ${pattern}:`, error);
    }
  }
  ...
  async increment(key: string, options?: CacheOptions): Promise<number> {
    try {
      ...
      safeLogger.error(`Error incrementing key ${key}:`, error);
      return 0;
    }
  }
  ...
  async exists(key: string, options?: CacheOptions): Promise<boolean> {
    try {
      ...
      safeLogger.error(`Error checking key ${key}:`, error);
      return false;
    }
  }
  ...
  async setExpireAt(key: string, value: any, timestamp: number, options?: CacheOptions): Promise<void> {
    try {
      ...
      safeLogger.error(`Error setting key with expireAt ${key}:`, error);
    }
  }
  ...
  async clearAll(): Promise<void> {
    try {
      ...
      safeLogger.info(`Cleared ${keys.length} cache keys`);
    } catch (error) {
  ...
  async warmUpCache(data: {
    ...
    try {
      ...
      safeLogger.info('Cache warmed up successfully');
    } catch (error) {
      safeLogger.error('Error warming up cache:', error);
    }
  }
