-- Migration: Update Seller Tier System
-- Description: Update both sellers and sellerVerifications tables to use the new tier system
-- Date: 2025-01-24
...
-- Update sellerVerifications table first to avoid constraint issues
